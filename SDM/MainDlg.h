...
public:
	...
	BEGIN_MSG_MAP(CMainDlg)
		...
		COMMAND_ID_HANDLER(IDC_PULL,OnPull)
        MESSAGE_HANDLER(WM_DESTROY,OnDestroy)
        COMMAND_ID_HANDLER(IDC_ADD_FILES,OnAddFiles)
        COMMAND_ID_HANDLER(IDC_SET_DEST,OnSetDestination)
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	LRESULT OnPull(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/);
	...
	std::string GetNtosFileName();
    std::wstring StringToWstring(const std::string& str);
    void AddFile(std::wstring path);
    void SetDestination(std::wstring path);
